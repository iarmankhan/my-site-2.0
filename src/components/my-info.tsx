  ...
  return (
    <div className='flex flex-col md:flex-row items-center gap-4'>
      <div className='text-center md:text-left'>
        ...
        <p className='font-semibold text-gray-600 mt-4 text-2xl md:text-4xl'>Full stack engineer</p>
      ...
      <div className='ml-0 mt-6 md:mt-0 md:ml-4 lg:ml-10'>
        <div className='relative w-48 h-48 md:w-64 md:h-64'>
          <Image className='rounded-full bg-gray-200' src='/assets/programming-me.png' priority width={350} height={350} alt={"Avatar"} />
        </div>
      </div>
    </div>
  )
