    ...
    <footer className="relative mt-auto border-t-4 border-black bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  href="/blog"
                  className="inline-block text-black hover:text-black hover:bg-yellow-400 px-3 py-1 transition-all duration-200 font-medium"
                >
                  Blog
                </Link>
              </li>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="p-3 brutalist-border text-black hover:bg-yellow-400 transition-all duration-200"
                aria-label="GitHub"
              >
        ...
        <div className="pt-8 border-t-2 border-black">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-black/70">
