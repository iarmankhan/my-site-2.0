...
seoTitle: "git-tidy: A Safe CLI for Cleaning Up Stale Git Branches"
slug: git-tidy
date: 2026-06-17
description: "git-tidy: a small CLI for cleaning up stale branches. I used it to clear 449 dead ones across three repos."
seoDescription: "git-tidy is a small CLI for safely cleaning up stale Git branches with dry-run output, protected branches, remote branch support, and JSON output for agents."
featured: true
draft: false
---
...
> `git-tidy` is a small CLI that finds stale Git branches, previews what it would delete, protects important branches, and only deletes after you explicitly run it.
